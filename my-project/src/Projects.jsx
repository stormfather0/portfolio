          ...
          >
            ...
            <div className="flex-1 p-4 sm:p-6 md:p-8 flex flex-col justify-center">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                <span className="inline-block bg-blue-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-2xl font-semibold shadow-md hover:bg-blue-600 hover:shadow-lg transition-all duration-300 cursor-pointer text-sm sm:text-base text-center">
                  View Project
                </span>
                <div className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full shadow-md hover:scale-110 hover:shadow-lg transition-transform duration-300"
                  >
                    <svg
